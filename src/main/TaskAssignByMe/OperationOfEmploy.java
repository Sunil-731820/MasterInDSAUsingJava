...
public class OperationOfEmploy {
    ...
    public static List<Employ> addEmployInArrayList() {
        ...
        // 1: Yea it is Already Mentioned That add 10 Object only In The Array List So
        // size = 10
        for (int i = 0; i < 3; i++) {
        ...
        for (Employ employ : listOfEmploy) {
            System.out.println(employ.getEmpId() + " " + employ.getEmpFirstName() + " " + employ.getEmpLastName() + " "
                    + employ.getEmpcity() + " " + employ.getEmpSalary() + " " + employ.getEmpEmailId() + " "
                    + employ.getEmpPincode());
        }
        return listOfEmploy;
    }
